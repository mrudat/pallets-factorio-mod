...
case "$TYPE" in
  thumbnail)
    povray +I${SCENE} $OPTIONS $thumbnail_size -o${tempdir}/alpha.png DECLARE=Variant=1 +ua
    povray +I${SCENE} $OPTIONS $thumbnail_size -o${tempdir}/bkg.png DECLARE=Variant=2
    povray +I${SCENE} $OPTIONS $thumbnail_size -o${tempdir}/shadow.png DECLARE=Variant=3
